...
public class WXPay {
	...
	public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
		...
		reqData.put("sign", WXPayUtil.generateSignature(reqData, getKey(), this.signType));
		return reqData;
	}
	...
	public boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
		...
		return WXPayUtil.isSignatureValid(reqData, getKey(), this.signType);
	}
	...
	private String getKey() {
		String key = "";
		if (useSandbox) {
			key = this.config.getSandBoxApiKey();
		} else {
